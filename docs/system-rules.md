...
Canonical **non-journey** rules: behaviour, copy expectations, and field rules that apply across flows. **Journey diagrams** stay in [`journeys/`](journeys/README.md). Product overview: [`../giggi.md`](../giggi.md).
...
**Context:** [`../giggi.md`](../giggi.md) §1.1, §5.E, §13–14.
...
- **Refine trust scoring** over time, consistent with [`../giggi.md`](../giggi.md) §14 and journey trust-signal notes.
...
Align with [`../giggi.md`](../giggi.md) §16 (e.g. AI dispute resolution, trust scoring) when scoping.
...
**MVP scope:** the platform does **not** process payments or escrow ([`../giggi.md`](../giggi.md) §2, §16). These fields exist so ads and **agreements** make **how and when** payment is expected **explicit**, reducing friction and disputes. All values are **disclosure + commitment** only until a payments product exists.
...
| **Agreement** | **Required** before lock: chosen **payment timing** and **payment method** must appear in the negotiated agreement text/UI so both parties accept the same version ([Agreement negotiation](journeys/agreement-negotiation.md), [`../giggi.md`](../giggi.md) §3 Agreement, §5.D). |
...
Suggestions feed **gig creation** and **agreement draft** pre-fill; they **never** auto-lock an agreement ([`../giggi.md`](../giggi.md) §10, agreement journey AI rules).
...
- [ ] Copy and validation aligned with [`../giggi.md`](../giggi.md) §3 and §5.D.
...
- Journey references: [Home → chat](journeys/home-to-chat.md), [Browse → hire](journeys/browse-to-hire.md); narrative: [`../giggi.md`](../giggi.md) §5.C.
